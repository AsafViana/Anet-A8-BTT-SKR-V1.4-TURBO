...
// Choose the name from boards.h that matches your setup
  ...
  #undef TEMP_0_PIN
  #undef TEMP_BED_PIN
  #define TEMP_0_PIN       P0_23_A0   // TH1 (3V funcionando)
  #define TEMP_BED_PIN     P0_25_A2   // TB para cama (SKR V1.4 Turbo)

  #define TEMP_SENSOR_0     1     // 100K NTC Extrusor (TH1)
  #define TEMP_SENSOR_BED   1     // 100K NTC Cama (TB)
#endif
